...
import {
    ...
    ConfirmationNumberOutlined, EscalatorWarningOutlined, FemaleOutlined,
...
export const SideMenu = () => {
    return (
        <Drawer
            ...
            anchor="right"
            sx={{
                backdropFilter: 'blur(3px)', //parte del drawer es lo que esta en todo el fondo asi que dejo borroso el fondo
